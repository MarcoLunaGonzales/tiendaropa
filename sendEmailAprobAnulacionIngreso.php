...
$codigo_generadoX=$codigoGeneradoX;

$claveAprobacion=generarCodigoAprobacion($codigo_generadoX);
...
$personal="2";
$evento="Aprobacion para Anulacion de Ingreso";
$titulo="Aprobacion para Anulacion de Ingreso";
$mensaje=""; 
...
//INICIO MENSAJE
	...
	$mensaje.="<span>Estimad@ Usuari@: TuFarma comunica que se requiere su aprobacion para la anulación del siguiente ingreso:</span><br>";
	...
	$mensaje.="<span>El codigo de aprobacion de la anulacion es: </span><span style='color:red;'>$claveAprobacion</span><br>";
