...
function ajaxBuscarPreIngresos(f){
	...
	ajax.open("GET", "ajaxNavPreIngresos.php?fechaIniBusqueda="+fechaIniBusqueda+"&fechaFinBusqueda="+fechaFinBusqueda+"&notaIngreso="+notaIngreso+"&global_almacen="+global_almacen+"&provBusqueda="+provBusqueda,true);
...
<input type='button' value='Editar' class='boton' onclick='editar_ingreso(this.form)'>
<input type='button' value='Anular' name='adicionar' class='boton2' onclick='anular_ingreso(this.form)'>
...
while ($dat = mysqli_fetch_array($resp)) {
	...
	<td>&nbsp;$obs_ingreso</td>
	<td align='center'>
		<a target='_BLANK' href='navegador_predetalleingresomateriales.php?codigo_ingreso=$codigo'><img src='imagenes/icon_detail.png' border='0' width='30' heigth='30' title='Ver Detalles del Ingreso'></a>
	</td>
	<td align='center'>
		...
		<table align='center' class='texto'>
			...
			<tr>
				...
				<td>
					...
					<?php
						$sqlProv="select cod_proveedor, nombre_proveedor from proveedores where cod_proveedor 
						in( select cod_proveedor from funcionarios_proveedores where codigo_funcionario=$global_usuario) order by 2";
