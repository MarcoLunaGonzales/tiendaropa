...
{	var rpt_territorio,fecha_ini, fecha_fin, rpt_ver;
    ...
    if(forms.checkValidity()){
		window.open('rptVentasMarcasDet.php?rpt_territorio='+rpt_territorio+'&rpt_marca='+rpt_marca+'&rpt_tipoPago='+rpt_tipoPago+'&fecha_ini='+fecha_ini+'&fecha_fin='+fecha_fin+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');			
		return(true);    
	} else{
