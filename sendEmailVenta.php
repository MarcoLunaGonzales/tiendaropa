...
//INICIO MENSAJE
	...
	if($evento_salida==1){
			$mensaje.="<span>Estimad@ Usuari@: TuFarma comunica que tuvo lugar la salida de producto en la transaccion:</span><br>";
	}if($evento_salida==2){
		$mensaje.="<span>Estimad@ Usuari@: TuFarma comunica que tuvo lugar la anulacion del siguiente documento:</span><br>";		
	}
