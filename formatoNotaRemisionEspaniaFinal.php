...
while($datDetalle=mysqli_fetch_array($respDetalle)){
	...
	$pdf->SetXY(10,$yyy);	
	$pdf->Cell(80,8,utf8_decode($nombreMat),0,0,"L");
	$pdf->SetXY(125,$yyy);		
	$pdf->Cell(15,8,$cantUnit,0,0,"R");
	$pdf->SetXY(152,$yyy);		
   $pdf->Cell(15,8,(number_format($montoUnit,2,'.','')).iconv('UTF-8', 'windows-1252', $euro),0,0,"R");
	$pdf->SetXY(179,$yyy);		
	$pdf->Cell(20,8,(number_format($cantUnit*$montoUnit,2,'.','')).iconv('UTF-8', 'windows-1252', $euro),0,0,"R");
