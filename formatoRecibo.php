...
$pdf->SetXY(4,$y+15);		$pdf->Cell(68,0,utf8_decode("Nro Cliente: ").utf8_decode($cel_recibo),0,0,"C");
$pdf->SetXY(4,$y+19);		$pdf->Cell(68,0,utf8_decode("FECHA: ").$fecha_recibo_mostrar,0,0,"C");
$pdf->SetFont('Arial','',8);
$pdf->SetXY(4,$y+22);		$pdf->Cell(68,0,"---------------------------------------------------------------------------", 0,0,"C");
$pdf->SetFont('Arial','',8);

$pdf->SetXY(4,$y+26);		$pdf->MultiCell(68,3,utf8_decode($direccionTxt), 0,"C");
$pdf->SetXY(4,$y+34);		$pdf->Cell(68,0,"Telefono:  ".$telefonoTxt,0,0,"C");
$pdf->SetXY(4,$y+38);		$pdf->Cell(68,0,$ciudadTxt,0,0,"C");
$pdf->SetXY(4,$y+42);		$pdf->Cell(68,0,"---------------------------------------------------------------------------", 0,0,"C");
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(4,$y+46);		$pdf->Cell(15,0,"DETALLE:",0,0,"L");
$pdf->SetFont('Arial','',8);

$pdf->SetXY(4,$y+50);		$pdf->MultiCell(68,3,utf8_decode($desc_recibo), 0,"L");
$pdf->SetXY(4,$y+58);		$pdf->Cell(68,0,"---------------------------------------------------------------------------", 0,0,"C");
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(4,$y+62);		$pdf->Cell(68,0,"Monto Recibido:".$monto_recibo,0,0,"R");
...
$pdf->SetXY(4,$y+66);		$pdf->MultiCell(68,3,"Son:  $txtMonto"." ".$montoDecimal."/100 Bolivianos",0,"L");
$pdf->SetFont('Arial','',8);
$pdf->SetXY(4,$y+70);		$pdf->Cell(68,0,"---------------------------------------------------------------------------",0,0,"C");
$pdf->SetXY(4,$y+74);		$pdf->Cell(68,0,"Cajero(a): $usuReg",0,0,"C");
