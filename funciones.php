...
function actualizaNombreProducto($enlaceCon,$codProducto){
	...
	while($dat=mysqli_fetch_array($resp))
	{
		...
		$sqlActualizanombre="update material_apoyo set descripcion_material='".$grupo." ".$subgrupo." ".$nombreModelo." ".$nombreGenero." ".$nombreMaterial." ".$nombreColor." ".$nombreTalla."' where codigo_material=".$codProducto;
