...
{	var rpt_territorio,fecha_ini, fecha_fin, rpt_ver,rpt_marca;
    ...
    if(forms.checkValidity()){
		window.open('rptVentasGeneral.php?rpt_territorio='+rpt_territorio+'&rpt_marca='+rpt_marca+'&fecha_ini='+fecha_ini+'&fecha_fin='+fecha_fin+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');			
		return(true);    
	} else{
...
echo"<form method='post' action=''>";
	...
	echo "</select></td></tr>";
	echo "<tr><th align='left'>Marcas</th><td><select name='rpt_marca' id='rpt_marca' class='texto' size='10' multiple>";
