...
$sql="select f.direccion from facturas_venta f 
...
$sql="select f.dir_cliente from clientes f 
...
echo "<input type='text' value='$nombre' class='form-control' name='razonSocialDireccion' id='razonSocialDireccion' required style='text-transform:uppercase;'  onchange='ajaxNitCliente(this.form);' onkeyup='javascript:this.value=this.value.toUpperCase();' placeholder='Ingrese la razon social' pattern='[A-Za-z0-9Ññ.& ]+'>";
