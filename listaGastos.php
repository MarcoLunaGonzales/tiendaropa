...
where r.cod_ciudad=".$global_agencia." order by r.id_recibo DESC ";
...
g.created_by,g.modified_by,g.created_date,g.modified_date,g.gasto_anulado,g.cod_proveedor, p.nombre_proveedor
from gastos g
