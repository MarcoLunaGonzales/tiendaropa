            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header card-header-icon">
                  ...
                  <h4 class="card-title">SINCRONIZACION DE PARAMETRICA DE EVENTOS SIGNIFICATIVOS <a href="index.php" class="btn btn-danger float-right"><i class="material-icons">arrow_left</i>Volver</a></h4>                  
                </div>
                <div class="card-body">
