...
while($datEdit=mysql_fetch_array($respEdit)){
	...
	$descripcionMaterialX=$datEdit[2];
	$codLineaX=$datEdit[3];
	$codGrupoX=$datEdit[4];
	$codTipoX=$datEdit[5];
...
echo "<td align='left' colspan='3'>
	<input type='text' class='texto' name='observaciones' id='observaciones' value='$descripcionMaterialX' size='100' style='text-transform:uppercase;'>
	</td>";
