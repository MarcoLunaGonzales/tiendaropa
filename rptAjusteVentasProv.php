...
where g.cod_ciudad=".$global_agencia." and g.cod_proveedor=".$codProveedor." and gasto_anulado=0 ";
$consultaGasto = $consultaGasto." AND g.fecha_gasto BETWEEN '".$fecha_iniconsulta."' and '".$fecha_finconsulta."'";
$consultaGasto = $consultaGasto."order by g.cod_gasto desc";
