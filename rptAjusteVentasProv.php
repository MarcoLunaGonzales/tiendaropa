...
<?php 
	...
	?>
	<tr>
		<td align="right" colspan="12"><strong>TOTAL VENTA <?php echo $nombreProveedor;?></strong></td>
...
<?php		
	...
	?>
		<tr>
			<td align='right' colspan="12"><STRONG>TOTAL RECIBOS <?php echo $nombreProveedor;?> </strong></td>
			<td align='right'>&nbsp;</td>
			<td align='right'>&nbsp;</td>
			<td align='right'><STRONG><?=$totalRecProveedor;?></strong></td>
		</tr>
		<tr bgcolor='#d3ffce'  >
			<td align='right' colspan="12" ><STRONG>TOTAL INGRESO <?php echo $nombreProveedor;?> </strong></td>
			<td align='right'>&nbsp;</td>
			<td align='right'>&nbsp;</td>
...
<?php		
	...
	?>
		<tr >
			<td align='right' colspan="12"><STRONG>TOTAL EGRESO RECIBOS <?php echo $nombreProveedor;?> </strong></td>
			<td align='right'>&nbsp;</td>
			<td align='right'>&nbsp;</td>
...
where g.cod_ciudad=".$global_agencia." and g.cod_tipogasto=2 and g.cod_proveedor=".$codProveedor." order by g.cod_gasto desc";
...
?>	
		...
		<tr bgcolor="F6D2CA">
			<td align='right' colspan="12"><STRONG>TOTAL EGRESO <?php echo $nombreProveedor;?> </strong></td>
			<td align='right'>&nbsp;</td>
			<td align='right'>&nbsp;</td>
			<td align='right'><STRONG><?=$totalEgresoProveeedor;?></strong></td>
		</tr>	
				<tr bgcolor="#F8FBB7">
			<td align='right' colspan="12"><STRONG>MONTO A FAVOR DE <?php echo $nombreProveedor;?> </strong></td>
			<td align='right'>&nbsp;</td>
			<td align='right'>&nbsp;</td>
